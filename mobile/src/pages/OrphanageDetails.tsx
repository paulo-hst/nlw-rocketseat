...
export default function OrphanageDetails() {
  ...
  // recebe o ID do orfanato da página OrphanagesMap
  const route = useRoute();
  const [orphanage, setOrphanage] = useState<Orphanage>();
  
  // forçando o params a ter o formato da interface. permite acesso ao ID
  ...
  if(!orphanage){ // se o orfanato não estiver carregado
    return (
